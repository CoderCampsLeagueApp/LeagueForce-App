(function(){
	...
	CommentsController.$inject = ['UserFactory', '$state', '$stateParams', '$rootScope', 'ProfileFactory', 'AdminFactory'];

	function CommentsController(UserFactory, $state, $stateParams, $rootScope, ProfileFactory, AdminFactory){
		var vm = this;
		vm.newsletter = {};
